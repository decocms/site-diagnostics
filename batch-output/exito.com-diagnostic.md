...
> **Note:** The Éxito homepage screenshot could not be captured — the page was behind a Cloudflare WAF challenge. The screenshot was disqualified from analysis as it captured only a bot-protection interstitial, not actual site content.
...
The pattern is clear: "Lleva a casa fácil y rápido {product name}. Encuentra la mejor garantía. Compra seguro en exito.com." This provides no differentiated value to searchers and reduces CTR potential. Unique, keyword-targeted product descriptions can meaningfully increase organic traffic per PDP.
...
Without Product structured data, exito.com is not eligible for rich snippets showing price, availability, and ratings in Google search results. Rich snippets can meaningfully increase CTR for eligible search results. For a marketplace with thousands of products competing for high-intent queries like "comprar celular online colombia" (where exito.com was not found in the top 10 results per DataForSEO, Colombia, April 2026), this is a material competitive disadvantage.
...
Unique product descriptions can meaningfully increase organic traffic per PDP. For a marketplace competing against specialized retailers like Alkosto, Falabella, and Claro's online store, descriptive content is what differentiates a listing from a commodity.
...
Neither of the 2 scraped PDPs contained a review section, rating display, or review count. The scraped markdown shows no review-related elements anywhere on the page. Without reviews, the site misses both conversion optimization and structured data enrichment. Products with 5 or more reviews see approximately 270% higher purchase likelihood versus products with no reviews (Spiegel Research Center, 2017).
...
Neither of the 2 scraped PDPs contained a "related products," "customers also bought," or "complete the look" section. The scraped content ends after the specification table and a cookie consent banner. Personalization — including product recommendations — drives a 5–15% revenue lift (McKinsey, 2021).

| Action | Pages affected |
|---|---|
| Add cross-sell / recommendation blocks to PDPs | Entire product catalog |

> **Note:** The Éxito PDP screenshot could not be captured — the page was behind a Cloudflare WAF challenge. The screenshot was disqualified from analysis as it captured only a bot-protection interstitial, not an actual product detail page.

> **Note:** The Éxito Samsung celulares PLP screenshot could not be captured — the page was behind a Cloudflare WAF challenge. The screenshot was disqualified from analysis as it captured only a bot-protection interstitial, not the actual product listing page.
...
- Spiegel Research Center (2017): Products with 5+ reviews see approximately 270% higher purchase likelihood
- McKinsey (2021): Personalization drives 5–15% revenue lift
...
- screenshot: 3 screenshots attempted (all blocked by Cloudflare WAF challenge; all disqualified from analysis)
